# -*- coding: utf-8 -*-
"""
Created on Thu Jul 16 10:57:30 2020
...
#变量存放在varible
weight_input_to_hidden = tf.Variable(tf.random_normal([input_nodes,hidden_nodes],stddev=0.1))
weight_hidden_to_output = tf.Variable(tf.random_normal([hidden_nodes,1],stddev=0.1))


#构建图
hidden_inputs = tf.matmul(train_x,weight_input_to_hidden)
hidden_outputs = tf.sigmoid(hidden_inputs)

final_outputs = tf.matmul(hidden_outputs,weight_hidden_to_output)
